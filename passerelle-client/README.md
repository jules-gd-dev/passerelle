...
* **Author**: Jules GD (julesgd.dev) | **GitHub**: [jules-gd-dev/paserelle-deamon](https://github.com/jules-gd-dev/paserelle-deamon) | **Sponsors**: [Support on GitHub](https://github.com/sponsors/jules-gd-dev) | **License**: MIT
